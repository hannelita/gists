...
[source,cypher]
----
{"parameters": {"topics": ["keynote", "spring"], "_id": "56299173867791a26a71a3ec", "room": "Auditorium", "timeslot": "Wed 29th, 09:30-10:30"}}
CREATE (c:Document:talks { parameters })
{"parameters": {"abstract": "Spring emerged as a core open source project in early 2003 and evolved to a broad portfolio of open source projects up until 2015.", "_id": "56299173867791a26a71a3ec", "title": "12 Years of Spring: An Open Source Journey"}}
CREATE (c:Document:session { parameters })
{"parameters": {"bio": "Juergen Hoeller is co-founder of the Spring Framework open source project.", "twitter": "https://twitter.com/springjuergen", "_id": "56299173867791a26a71a3ec", "name": "Juergen Hoeller", "picture": "http://www.springio.net/wp-content/uploads/2014/11/juergen_hoeller-220x220.jpeg"}}
CREATE (c:Document:speaker { parameters })
{"doc_id": "56299173867791a26a71a3ec", "explicit_id": "56299173867791a26a71a3ec"}
